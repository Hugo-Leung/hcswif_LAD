...
source setup.csh
cd -
setenv LD_LIBRARY_PATH "$HOME/hallc/software/hcana/install/lib64:$LD_LIBRARY_PATH"
setenv PATH "$HOME/hallc/software/hcana/install/bin:$PATH"
setenv HCANA "$HCANALYZER"

# for LAD
setenv LD_LIBRARY_PATH "$HOME/hallc/software/LADlib/install/lib64:$LD_LIBRARY_PATH"
setenv PATH "$HOME/hallc/software/LADlib/install/include:$PATH"
...
# -----------------------------------------------------------------------------
#  Change these if this is not where hallc_replay and hcana live
# setenv REPLAYDIR /group/nps/$USER/nps_replay
echo "Modules in use:"
module list
